...
const en: Dictionary = {
    ...
    // PRP v6 Phase 3 — workflow keys (added 2026-05-10)
    'maintenance.list.title': 'Maintenance Requests',
    'maintenance.list.subtitle': 'Manage all repair requests',
    'maintenance.list.new': 'New Request',
    'maintenance.list.empty': 'No maintenance requests',
    ...
    'maintenance.category.mechanical': 'Mechanical',
    'maintenance.category.software': 'Software',
    'maintenance.category.physical': 'Physical',
    'maintenance.category.other': 'Other',
    'maintenance.req-status.open': 'Open',
    'maintenance.req-status.assigned': 'Assigned',
    'maintenance.req-status.in_progress': 'In Progress',
    'maintenance.req-status.awaiting_parts': 'Awaiting Parts',
    'maintenance.req-status.resolved': 'Pending Verification',
    'maintenance.req-status.closed': 'Closed',
    'maintenance.req-status.cancelled': 'Cancelled',
    'maintenance.action.start-work': 'Start Work',
    'maintenance.action.mark-awaiting-parts': 'Awaiting Parts',
    'maintenance.action.resume-work': 'Resume Work',
    'maintenance.action.mark-resolved': 'Mark Resolved',
    'maintenance.action.approve': 'Approve (Close)',
    'maintenance.action.reject': 'Reject',
    'maintenance.action.cancel-item': 'Cancel This Item',
    'maintenance.action.cancel-request': 'Cancel Request',
    'maintenance.action.reopen': 'Reopen',
    'maintenance.action.delete': 'Delete',
    'maintenance.action.print': 'Print',
    'maintenance.action.report': 'Report Issue',
    'maintenance.dashboard.total': 'Total Requests',
    'maintenance.dashboard.avg-resolve': 'Avg Resolve Time',
    'maintenance.dashboard.avg-close': 'Avg Close Time',
    'maintenance.dashboard.cost-actual': 'Actual Cost',
    'maintenance.dashboard.cost-estimated': 'Estimated',
    'maintenance.pending-verification.title': 'Awaiting Your Verification',
    'maintenance.pending-verification.subtitle': 'Items have been repaired — please verify and close',
...
const th: Dictionary = {
    ...
    // PRP v6 Phase 3 — workflow keys (added 2026-05-10)
    'maintenance.list.title': 'รายการแจ้งซ่อม',
    'maintenance.list.subtitle': 'จัดการคำขอซ่อมบำรุงทั้งหมด',
    'maintenance.list.new': 'แจ้งซ่อมใหม่',
    'maintenance.list.empty': 'ไม่มีคำขอแจ้งซ่อม',
    'maintenance.severity.low': 'ต่ำ',
    'maintenance.severity.medium': 'กลาง',
    'maintenance.severity.high': 'สูง',
    'maintenance.severity.critical': 'วิกฤต',
    'maintenance.priority.low': 'ต่ำ',
    'maintenance.priority.normal': 'ปกติ',
    'maintenance.priority.high': 'เร่งด่วน',
    'maintenance.priority.urgent': 'ด่วนมาก',
    'maintenance.category.electrical': 'ไฟฟ้า',
    'maintenance.category.mechanical': 'เครื่องกล',
    'maintenance.category.software': 'ซอฟต์แวร์',
    'maintenance.category.physical': 'กายภาพ',
    'maintenance.category.other': 'อื่นๆ',
    'maintenance.req-status.open': 'รอดำเนินการ',
    'maintenance.req-status.assigned': 'มอบหมายแล้ว',
    'maintenance.req-status.in_progress': 'กำลังซ่อม',
    'maintenance.req-status.awaiting_parts': 'รออะไหล่',
    'maintenance.req-status.resolved': 'รอตรวจรับ',
    'maintenance.req-status.closed': 'ปิดงาน',
    'maintenance.req-status.cancelled': 'ยกเลิก',
    'maintenance.action.start-work': 'เริ่มซ่อม',
    'maintenance.action.mark-awaiting-parts': 'รออะไหล่',
    'maintenance.action.resume-work': 'กลับมาทำงานต่อ',
    'maintenance.action.mark-resolved': 'บันทึกซ่อมเสร็จ',
    'maintenance.action.approve': 'ตรวจรับ (ปิดงาน)',
    'maintenance.action.reject': 'ปฏิเสธ',
    'maintenance.action.cancel-item': 'ยกเลิกอุปกรณ์นี้',
    'maintenance.action.cancel-request': 'ยกเลิกคำขอ',
    'maintenance.action.reopen': 'เปิดงานใหม่',
    'maintenance.action.delete': 'ลบ',
    'maintenance.action.print': 'พิมพ์',
    'maintenance.action.report': 'แจ้งซ่อม',
    'maintenance.dashboard.total': 'คำขอทั้งหมด',
    'maintenance.dashboard.avg-resolve': 'เวลาซ่อมเฉลี่ย',
    'maintenance.dashboard.avg-close': 'เวลาปิดงานเฉลี่ย',
    'maintenance.dashboard.cost-actual': 'ค่าใช้จ่ายจริง',
    'maintenance.dashboard.cost-estimated': 'ประมาณ',
    'maintenance.pending-verification.title': 'รอคุณตรวจรับ',
    'maintenance.pending-verification.subtitle': 'ช่างซ่อมเสร็จแล้ว — กรุณาตรวจสอบและยืนยันการปิดงาน',
